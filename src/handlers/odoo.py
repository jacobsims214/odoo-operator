    ...
    for addon in addons:
        ...
        script_lines.extend(
            [
                ...
                "  # ── No local clone found — fresh clone",
                f"  if [ -d '{target_dir}' ]; then",
                "    echo '[addon] Stale/incomplete directory found, removing...'",
                f"    rm -rf {target_dir}",
                "  fi",
